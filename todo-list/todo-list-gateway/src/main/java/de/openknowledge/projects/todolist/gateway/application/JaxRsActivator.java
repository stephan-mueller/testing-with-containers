...
@Info(title = "Todo-List Gateway API", description = "Provides access to the API operations", version = "1.0.0",
    ...
    servers = @Server(url = "http://{host}:{port}/{context-root}", variables = {
        ...
        @ServerVariable(name = "port", defaultValue = "19080"),
        @ServerVariable(name = "context-root", defaultValue = "todo-list-gateway")
    }))
